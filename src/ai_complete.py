...
class AICompleter:
    ...
    def complete_missing_profiles(self, nodes: list):
        ...
        for node in nodes:
            ...
            Analizza il task e genera i 6 parametri etici separati da virgola:
            ...
            5. CRITERIA: True se il task richiede regole oggettive documentate (es. test, screening).
            6. OFF-HOURS: True se invia notifiche/email automatiche ai candidati fuori orario.
